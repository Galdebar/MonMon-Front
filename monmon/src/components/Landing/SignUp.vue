            ...
            handleResponse(response) {
                switch (response) {
                    ...
                    case "User Already Exists": {
                        let userExistsMsg = `Email ${this.userEmail} is already taken. Try another one`;
                        this.errorMessages.push(userExistsMsg);
                        this.showErrorMessage();
                        break;
                    }

                    case "Invalid Email": {
                        let invalidEmailMsg = "Invalid Email Address";
                        this.errorMessages.push(invalidEmailMsg);
                        this.showErrorMessage();
                        break;
                    }
...
<style lang="scss" scoped>
    ...
    .slide-fade-leave-active {
        transition: all $default-transition cubic-bezier(1.0, 0.5, 0.8, 1.0);
    }
